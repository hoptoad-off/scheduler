...
public class Cafeteria {
    ...
    public boolean checkStatus(){
        return LocalTime.now().isBefore(endTime) && LocalTime.now().isAfter(startTime) && isActive;
    }

    public void showWorkTime(){
        System.out.println("Cafeteria work time: " + startTime.toString() + "-" + endTime.toString());
    }
}
